...
public class ViewTextEditor extends Stage {
	...
	public ViewTextEditor(String path) {
		...
		reload = new MenuItem("重新加载文件", new ImageView("photo/reload.png"));
		saveCloud = new MenuItem("保存到云端", new ImageView("photo/save.png"));
		...
		close = new MenuItem("关闭", new ImageView("photo/exit.png"));
		...
		cancel = new MenuItem("撤销", new ImageView("photo/undo.png"));
		cancel.setAccelerator(new KeyCodeCombination(KeyCode.Z, KeyCombination.SHORTCUT_DOWN));
		redo = new MenuItem("重做", new ImageView("photo/redo.png"));
		redo.setAccelerator(new KeyCodeCombination(KeyCode.Y, KeyCombination.SHORTCUT_DOWN));
		selectAll = new MenuItem("全选", new ImageView("photo/selectAll.png"));
		selectAll.setAccelerator(new KeyCodeCombination(KeyCode.A, KeyCombination.SHORTCUT_DOWN));
		copy = new MenuItem("复制", new ImageView("photo/copyText.png"));
		copy.setAccelerator(new KeyCodeCombination(KeyCode.C, KeyCombination.SHORTCUT_DOWN));
		paste = new MenuItem("粘贴", new ImageView("photo/paste.png"));
		paste.setAccelerator(new KeyCodeCombination(KeyCode.V, KeyCombination.SHORTCUT_DOWN));
		cut = new MenuItem("剪切", new ImageView("photo/cut.png"));
		...
		fontSizeItems = new Menu("字号", new ImageView("photo/fontSize.png"));
		...
		fontFamilyItems = new Menu("字体", new ImageView("photo/fontFamily.png"));
